...
func (s *billableMetrics) FindBillableMetric(ctx context.Context, request operations.FindBillableMetricRequest) (*operations.FindBillableMetricResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/billable_metrics/{code}", request.PathParams)
...
func (s *billableMetrics) CreateBillableMetric(ctx context.Context, request operations.CreateBillableMetricRequest) (*operations.CreateBillableMetricResponse, error) {
	baseURL := s.serverURL
...
func (s *billableMetrics) DestroyBillableMetric(ctx context.Context, request operations.DestroyBillableMetricRequest) (*operations.DestroyBillableMetricResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/billable_metrics/{code}", request.PathParams)
...
func (s *billableMetrics) FindAllBillableMetricGroups(ctx context.Context, request operations.FindAllBillableMetricGroupsRequest) (*operations.FindAllBillableMetricGroupsResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/billable_metrics/{code}/groups", request.PathParams)
...
func (s *billableMetrics) FindAllBillableMetrics(ctx context.Context, request operations.FindAllBillableMetricsRequest) (*operations.FindAllBillableMetricsResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/billable_metrics/"
...
func (s *billableMetrics) UpdateBillableMetric(ctx context.Context, request operations.UpdateBillableMetricRequest) (*operations.UpdateBillableMetricResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/billable_metrics/{code}", request.PathParams)
