...
func (s *plans) FindPlan(ctx context.Context, request operations.FindPlanRequest) (*operations.FindPlanResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/plans/{code}", request.PathParams)
...
// Create a new plan
func (s *plans) CreatePlan(ctx context.Context, request operations.CreatePlanRequest) (*operations.CreatePlanResponse, error) {
	baseURL := s.serverURL
...
// Delete a plan
func (s *plans) DestroyPlan(ctx context.Context, request operations.DestroyPlanRequest) (*operations.DestroyPlanResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/plans/{code}", request.PathParams)
...
func (s *plans) FindAllPlans(ctx context.Context, request operations.FindAllPlansRequest) (*operations.FindAllPlansResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/plans/"
...
func (s *plans) UpdatePlan(ctx context.Context, request operations.UpdatePlanRequest) (*operations.UpdatePlanResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/plans/{code}", request.PathParams)
